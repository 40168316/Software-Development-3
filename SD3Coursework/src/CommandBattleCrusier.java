...
// Public class for the BattleCruiser which implements options which is part of the command pattern. This can move the ship or undo the ships moves.
...
public class CommandBattleCrusier extends EnemyShip implements Options{
	// Set the variables
	...
	public void move() {
		...
		System.out.println("BattleCrusier move successful - " + x + " " + y);
		GUI.crusiershipposx = x;
		GUI.crusiershipposy = y;
		GUI.movescrusier = moves;
		loops++;
	}
	...
	public void previousmove() {
		...
		GUI.crusiershipposx = x;
		GUI.crusiershipposy = y;
		System.out.println("BattleCrusier - Undo Move " + x +" " + y);
	}
	
	// Method which allows for the factory pattern to set the type of ship
	public CommandBattleCrusier() {
